declare module 'java-process/process' {
	...
	export function spawn(jarPath: string, args?: string[]): any;
	export default function config(jarPath: string, args: string[], readyFn: Function): Process;

}
declare module 'java-process' {
	export { default as java_process } from 'java-process/process';
